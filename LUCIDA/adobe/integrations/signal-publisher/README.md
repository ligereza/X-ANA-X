...
This is a dependency-free Python client for the local Adobe signal bridge. It is a transport adapter, not an implementation of XIO, VISUAL or PUPILA.
...
The same client can publish `visual` attention summaries or `pupila` collaboration summaries. Proposals are optional, confirmation-only and never become host commands.
