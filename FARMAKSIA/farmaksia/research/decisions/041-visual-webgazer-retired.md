# Decisión 041 — Retiro del adaptador WebGazer local y opt-in
...
FARMAKSIA **retira** WebGazer 3.5.3 del estado activo. El experimento 030 y sus
...
No queda una adaptación WebGazer activa. Cualquier futura medición visual debe
mantener separadas la geometría calibrada, los detectores y los modelos; no se
infieren estados humanos o farmacológicos ni se aplican recetas ópticas o de
pantalla mediante CSS.
...
- No se ejecutan pruebas bajo intoxicación ni se usa una medición ocular como
  proxy de neurotransmisores, ansiedad o estados internos.
