# Decisión 085 — PUPILA Visual: contrato de distancia relativa y escala visual

## Decisión

El siguiente experimento de PUPILA Visual partirá de una referencia `P0` detectada por
