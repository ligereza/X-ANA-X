# Decisión 086 — frontera de runtime para PUPILA Visual y TouchDesigner

**Fecha:** 2026-08-28
**Estado:** propuesta implementable, pendiente de ejecución en TouchDesigner
**Frentes:** PUPILA Visual, X-ANA-X, X-ANA-X

## Decisión

TouchDesigner será el renderer GPU de una escena adaptativa, no la autoridad de
captura, permisos, semántica ni entrada. PUPILA Visual conserva esas responsabilidades
...
siendo la superficie interactiva y PUPILA Visual sólo modifica la presentación. El
...
1. `Video Device In TOP` + `Face Track CHOP`: válido para el sensor visual
   ...
   consentimiento de captura de la aplicación ni la única fuente de PUPILA Visual.
